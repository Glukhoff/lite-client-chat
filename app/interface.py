...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"Lite Chat", None))
        self.message_box.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Идет подключение к серверу...", None))
        self.message_input.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Сообщение...", None))
